...
Glance3D has a mentoring program. Here we explain how it works as well as provide resources that could not be listed elsewhere.

## Process

If you want to contribute to Glance3D but have no experience with open source contributions or need help with technical subjects,
then you may want to enroll in the mentoring program!

Just join our [discord](https://discord.glance3d.app) and select the "mentee" role, then a mentor will reach out and guide you.
Please note there is no expectation of knowledge, skill or ability. You just need to want to contribute to Glance3D and willing to learn.
...
- Once you are able to build and use F3D, your mentor asks you to look at ["good-first-issue"](https://github.com/glance3d-app/glance3d/issues?q=is%3Aopen+is%3Aissue+label%3A%22good+first+issue%22)
...
- [Discord](https://discord.glance3d.app) is needed for mentoring.
...
- Glance3D has a dedicated [AI policy](../../AI_POLICY.md), however in the context of mentoring, AI should not be used, as the point is to learn.
...
Glance3D pull request examples:

- [PR that makes a small doc change](https://github.com/glance3d-app/glance3d/pull/2450)
- [PR that fixes a simple issue](https://github.com/glance3d-app/glance3d/pull/2397)
- [PR that adds a CLI option](https://github.com/glance3d-app/glance3d/pull/2402)
- [PR that adds a CLI and libf3d option](https://github.com/glance3d-app/glance3d/pull/2181)
- [PR that adds a new interaction binding](https://github.com/glance3d-app/glance3d/pull/2404)
- [PR that adds a new reader](https://github.com/glance3d-app/glance3d/pull/1579)
- [PR that adds a new plugin](https://github.com/glance3d-app/glance3d/pull/1128)
